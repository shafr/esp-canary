(function(window, document, L, baseclass, request) { 'use strict';'require baseclass';'require request';var rpcRequestID=1,rpcSessionID=L.env.sessionid||'00000000000000000000000000000000',rpcBaseURL=L.url('admin/ubus'),rpcInterceptorFns=[];return baseclass.extend({call:function(req,cb,nobatch){var q='';if(Array.isArray(req)){if(req.length==0)
